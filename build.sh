...
jspm build systemjs-babel.js ../systemjs-babel-browser.js --format cjs --skip-source-maps --minify --log ok
jspm build systemjs-babel.js ../systemjs-babel-node.js --format cjs --node --skip-source-maps --log ok
